                ...
                <div class="ec-cat-list card card-default mb-24px">
                    <div class="card-body">
                        <div class="ec-cat-form">
                            ...
                            ?>
                            <form action="{{ URL::to('/save-promotion-accessory') }}" method="post">
                                @csrf
                                <div class="form-group row">
                                    <label class="col-12 col-form-label">Mô tả</label>
                                    <div class="col-12">
                                        <textarea id="sortdescription" name="promotion_accessory_des" cols="40" rows="2" class="form-control"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12">
                                        <input id="text" name="promotion_accessory_price" class="form-control here slug-title"
                                            type="text">
                                    </div>
                                </div>
                                <div class="form-group row">
