...
@section('main_admin')
<div class="content">
    <form role="form" id="form-all" action="{{URL::to('/update-image/'.$edit_image->image_id)}}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
                                            ...
                                            <div class="avatar-preview ec-preview">
                                                <div class="imagePreview ec-div-preview">
                                                    <img class="ec-image-preview"
                                                        src="{{URL::to('public/upload/product_image/'.$edit_image -> image_url)}}"
                                                        alt="edit" />
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td ><a href="{{URL::to('/edit-image/'.$product_image->image_id)}}" class="btn btn-outline-success mt-1" ui-toggle-class="">
