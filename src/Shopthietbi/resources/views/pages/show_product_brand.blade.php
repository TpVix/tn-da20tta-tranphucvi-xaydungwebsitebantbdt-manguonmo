                                ...
                                <div class="product-default">
                                    <figure>
                                        <a href="{{ URL::to('/san-pham/' . $product_brand->product_slug) }}">
                                            <img src="{{ URL::to('public/upload/' . $product_brand->product_image) }}"
                                ...
                                @endif --}}
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title"> <a
                                                href="product.html">{{ $product_brand->product_name }}</a>
                                        </h3>
                                                ...
                                                @foreach ($active_promotion_new as $v_active_promotion)
                                                    @if ($v_active_promotion->promotion_status == 'Có')
                                                        @if ($v_active_promotion->promotion_option == '%')
                                                            <del
                                                                class="old-price">{{ number_format($product_brand->product_price) }}</del><br>
